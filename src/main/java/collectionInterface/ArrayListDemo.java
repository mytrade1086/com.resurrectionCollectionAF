...
public class ArrayListDemo {
	public static void main(String[] args) {
		...
		/*##ArrayList
		 ...
		 4. NOT THREAD SAFE. Multiple threads can access simultaneously. With Collections class
		    thread safety can be achieved
		 
		 5.   ArrayList<String> al=new ArrayList<String>();  
		      Creates empty array list with default initial capacity 10
		      
		      When arrayList reaches its maximum capacity new array list is created.Old elements are copied
		      into it and references moved.
